...
export default function FinanceCtegory() {
  ...
  return (
    <div className='admin-category'>
     ...
     <Link to='/warehouse/dashboard' style={{textDecoration:'none'}} ><h3>Warehouse Admin </h3></Link> 
  
        <div class="inputadmin">
        <Link to='/warehouse/dashboard' className='link_category' ><button class="value">
  ...
  {showSubLinks && (
          <div className="sub-links">
            ...
            <Link to="/warehouseordereditems/approved" className="sub-link">Approved</Link>
            <Link to="/warehouseordereditems/pending" className="sub-link">Pending</Link>
          
            <Link to="/warehouseordereditems/finished_packing" className="sub-link">Ready for Transport</Link>
            <Link to="/warehouseordereditems/completed_orders" className="sub-link">Completed Orders</Link>
          </div>
        )}
