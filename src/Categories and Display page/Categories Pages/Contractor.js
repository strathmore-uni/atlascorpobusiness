...
export default function Contractor({ handleAddProductDetails, cartItems }) {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3001/api/contractor")
      .then((response) => {
  ...
  const fetchItems = async () => {
    try {
      const response = await fetch("http://localhost:3001/api/contractor");
      if (!response.ok) {
