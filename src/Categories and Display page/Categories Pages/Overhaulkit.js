...
export default function Overhaulkit({ handleAddProductDetails, cartItems }) {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3001/api/overhaulkit")
      .then((response) => {
  ...
  const fetchItems = async () => {
    try {
      const response = await fetch("http://localhost:3001/api/overhaulkit");
      if (!response.ok) {
